        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-10 flex flex-col gap-10 text-base leading-7 text-[var(--color-secondary)]">
            ...
            <Article num={2} title="처리하는 개인정보의 항목">
              ...
              <p>
                AI 챗봇 이용 시에는 이용자가 입력한 질문 내용, 챗봇이 분류한
                문의 유형(예: 제품 추천, 배송 문의 등), 그리고 챗봇이 생성한
                답변 내용이 저장될 수 있습니다. 답변 내용은 분쟁 발생 시
                실제 안내 내용을 확인하기 위한 목적으로 보관되며, 회사가
                생성한 정형 답변이라 이용자의 개인정보를 담지 않습니다.
