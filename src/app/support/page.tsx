...
const faqs = [
  ...
  {
    q: "교환·반품은 어디에서 신청하나요?",
    a: "네이버 톡톡으로 고객센터에 문의해 주세요. 가장 빠르게 확인해 드립니다. 배송 파손이나 제작 오류로 확인되면 무료로 교환해 드립니다. 인디업 책상은 고객님만을 위한 사이즈로 제작하는 맞춤형 상품이라, 단순 변심이나 사용 흔적이 있는 경우의 반품은 어려운 점 양해 부탁드립니다.",
  },
  {
    q: "A/S는 어떻게 접수하나요?",
        ...
        <section className="grain relative overflow-hidden border-t border-white/10 px-6 py-16 sm:px-12 sm:py-16">
          <Reveal className="relative mx-auto grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            >
              ...
              <p className="mt-4 text-sm leading-7 text-white/70 sm:text-base">
                배송 파손·제작 오류가 있다면 네이버 톡톡으로 고객센터에 문의해 주세요. 가장 빠르게 안내받으실 수 있습니다. 인디업 책상은 고객님만을 위한 사이즈로 제작하는 맞춤형 상품이라, 단순 변심이나 사용 흔적이 있는 경우의 반품은 어려운 점 양해 부탁드립니다.
              </p>
            </div>
