...
- 상판: 18mm 두께 E0 등급 LPM
- 프레임 색상: 화이트, 블랙 (2종)
- 상판 색상·마감: 화이트, 블랙, 그레이, 나무무늬(마인파인츠), 멀바우 (총 5종)
- 1인용/2인용 책상은 일반 책상형과 컴퓨터책상형 두 가지 구성으로 제작됩니다. 컴퓨터책상형은 멀티탭거치대가 기본 포함되고(1인용 1개, 2인용 2개), 일반 책상형은 상판만 있는 단품 구성입니다.
...
고객이 제품을 추천해달라고 하면 사용 인원 또는 사용 용도 중 가장 필요한 정보 한 가지만 먼저 확인합니다. 필요한 정보가 이미 충분하면 바로 제품을 추천합니다.
