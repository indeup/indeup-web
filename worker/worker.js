...
- 제주 지역 추가 배송비는 20,000원, 제주를 제외한 그 외 도서산간 지역 추가 배송비도 20,000원입니다.
- 인디업 책상은 고객이 원하는 사이즈로 개별 제작하는 주문제작 상품입니다. 전자상거래법령상 주문제작 상품은 단순 변심에 의한 청약철회(반품)가 제한될 수 있습니다 — 단순 변심(고객 귀책사유)에 의한 반품은 불가능하다고 답합니다. 다만 배송 중 파손이나 제작 오류(회사 귀책사유)로 확인된 경우에는 무료로 교환합니다(반품이 아니라 교환으로 처리). "단순 변심이어도 반품비만 내면 가능하다"처럼 답하지 마세요 — 반품 자체가 불가능한 사유입니다.
